...
//             console.log('resObj.ingredients (totalCalories):' + resObj.ingredients);
...
//             console.log('resObj.ingredients (totalCarbs):' + resObj.ingredients);
//             for (var i=0;i=resObj.ingredients.length;i++) {
...
//             console.log('resObj.ingredients (totalSugar):' + resObj.ingredients);
//             for (var i=0;i=resObj.ingredients.length;i++) {
...
//             console.log('resObj.ingredients (totalFat):' + resObj.ingredients);
//             for (var i=0;i=resObj.ingredients.length;i++) {
//                total +=resObj.ingredients.ingredient.fat;
//             return total;
//             }
//         };
//         var totalProtein = function() {
//             console.log('resObj.ingredients (totalProtein):' + resObj.ingredients);
//             for (var i=0;i=resObj.ingredients.length;i++) {
...
//         res.locals.totalSugers = totalSugar;
